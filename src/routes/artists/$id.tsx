  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="relative rounded-2xl overflow-hidden p-6 sm:p-8 bg-gradient-to-b from-primary/20 via-white/5 to-transparent border border-white/10 shadow-2xl">
          <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 text-center sm:text-left">
            {/* Artist Avatar */}
            <div className="relative group shrink-0">
              <div className="size-36 sm:size-48 md:size-52 rounded-full overflow-hidden bg-neutral-900 border-2 border-white/10 shadow-2xl flex items-center justify-center">
            ...
            <div className="flex flex-col gap-y-2 min-w-0 flex-1">
              <div className="flex items-center justify-center sm:justify-start gap-1.5">
                <div className="size-4 rounded-full bg-sky-500 flex items-center justify-center text-black">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black font-heading tracking-tight text-white drop-shadow-sm">
                {data.artist.name}
              </h1>
              ...
              {/* Action Buttons Row */}
              <div className="flex items-center justify-center sm:justify-start gap-3.5 pt-3">
                <Button
                  size="icon-lg"
                  onClick={handlePlayAll}
                  aria-label="Play Artist"
                  className="size-12 sm:size-13 rounded-full bg-primary text-black hover:bg-primary/90 shadow-xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all"
                >
