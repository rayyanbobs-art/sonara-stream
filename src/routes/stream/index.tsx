...
function StreamRouteComponent() {
  return (
    <div className="w-full h-full overflow-y-auto px-3 sm:px-6 pt-[calc(4.75rem+env(safe-area-inset-top,0px))] md:pt-20 pb-32 sm:pb-36 space-y-6 custom-scrollbar">
